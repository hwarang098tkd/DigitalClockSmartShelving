...
int clockMinuteColour = 6553664000;//1677
int clockHourColour   = 6553664000; //7712

int clockMinuteColour_array[8]={13172480,10000,140000000,16711935,25700,16724580,65535,131699999999};
int clockHourColour_array[8]={13172480,10000,140000000,16711935,25700,16724580,65535,131699999999};
...
void loop() {
  ...
  delay(2000);   //this 5 second delay to slow things down during testing
...
int read_Buttons_M(){    
  ...
  if (buttonState_M == HIGH) {//read the button for Mins
    ...
    Serial.println("Button for MIN PRESSED !!!, Color for Mins: "); 
    Serial.print(clockMinuteColour);
    Serial.print(" , Array Posit: ");
    Serial.print(array_pos_M);
    Serial.print(" , Array Value-Color");
    Serial.print(clockMinuteColour_array[array_pos_M]);
...
int read_Buttons_H(){  
  ...
  if (buttonState_H == HIGH) {//read the button for Hours
    ...
    Serial.println("Button for Hour PRESSED !!!, Color for Hours:"); 
    Serial.print(clockHourColour);    
    Serial.print(" , Array Posit");
    Serial.print(array_pos_H);
    Serial.print(" , Array Value-Color");
    Serial.print(clockMinuteColour_array[array_pos_H]);
